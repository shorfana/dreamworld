                                            ...
                                            <?php $this->load->view("back/layout/alert.php");?>
                                                <form method="POST" action="<?= base_url('login/auth');?>">
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        ...
                                                        <label for="usernameEmail">Username / E-mail</label>
                                                    </fieldset>
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        <a href="<?php echo base_url()?>login/forgotPassword" class="card-link">Forgot Password?</a>
                                                    </div>
                                                    <!-- <a href="<?php echo base_url()?>dashboard" class="btn btn-outline-primary float-left btn-inline">Langsung Masuk</a> -->
