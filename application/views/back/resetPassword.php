                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form method="POST" action="<?php echo base_url().'login/updatePassword/token/'.$token;?>">
                                                    ...
                                                    <fieldset class="form-label-group">
                                                        <input type="password" name="confirmPassword" class="form-control" id="user-confirm-password" placeholder="Confirm Password" required>
                                                        <label for="user-confirm-password">Confirm Password</label>
                                                        <?= form_error('confirmPassword', '<small class="text-danger font-weight-bold">', '</small>'); ?>
                                                    </fieldset>
                                                    <div class="row pt-2">
