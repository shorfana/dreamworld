...
INSERT INTO `hotel` VALUES (16, '1', 'SWISS MAQAM', 680, 900, 1120, 'SWISS_MAQAM.jpg');
...
CREATE TABLE `pelayanan`  (
  ...
  `jenis_pelayanan` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `harga_pelayanan` double NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `pelayanan` VALUES (1, 'HANDLING', 205);
